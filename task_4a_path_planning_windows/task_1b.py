...
def detectMaze(warped_img):
    ...
    while y<= height-Y+1:
        ...
        while x<= width-X+1:
           ...
           if y==0:
             A[i][j]+= 2**0
           #Checking the midpoint of the left edge with a tolerance of 5 points on either side of the edge
           else:
             l1= [gray1[x+(X//2),y-5]<100,gray1[x+(X//2),y-4]<100,gray1[x+(X//2),y-3]<100,gray1[x+(X//2),y-2]<100,gray1[x+(X//2),y-1]<100,gray1[x+(X//2),y]<100,gray1[x+(X//2),y+1]<100,gray1[x+(X//2),y+2]<100,gray1[x+(X//2),y+3]<100,gray1[x+(X//2),y+4]<100,gray1[x+(X//2),y+5]<100]
             if any(l1):
                 A[i][j]+= 2**0
           #Checking if the point is on the topmost edge of the image
           if x==0:
              A[i][j]+= 2**1
           #Checking the midpoint of the top edge with a tolerance of 5 points on either side of the edge
           else:
              l2= [gray1[x-5,y+(Y//2)]<100,gray1[x-4,y+(Y//2)]<100,gray1[x-3,y+(Y//2)]<100,gray1[x-2,y+(Y//2)]<100,gray1[x-1,y+(Y//2)]<100,gray1[x,y+(Y//2)]<100,gray1[x+1,y+(Y//2)]<100,gray1[x+2,y+(Y//2)]<100,gray1[x+3,y+(Y//2)]<100,gray1[x+4,y+(Y//2)]<100,gray1[x+5,y+(Y//2)]<100]
              if any(l2):
                 A[i][j]+= 2**1
           #Checking if the point is on the righttmost edge of the image(y+Y*10=510)
           if y+Y== 510:
              A[i][j]+= 2**2
           #Checking the midpoint of the right edge with a tolerance of 5 points on either side of the edge
           else:
              l3= [gray1[x+(X//2),y+Y-5]<100,gray1[x+(X//2),y+Y-4]<100,gray1[x+(X//2),y+Y-3]<100,gray1[x+(X//2),y+Y-2]<100,gray1[x+(X//2),y+Y-1]<100,gray1[x+(X//2),y+Y]<100,gray1[x+(X//2),y+Y+1]<100,gray1[x+(X//2),y+Y+2]<100,gray1[x+(X//2),y+Y+3]<100,gray1[x+(X//2),y+Y+4]<100,gray1[x+(X//2),y+Y+5]<100]
              if any(l3):
                 A[i][j]+= 2**2
           #Checking if the point is on the bottommost edge of the image(x+X*10=510)
           if x+X== 510:
              A[i][j]+= 2**3
           #Checking the midpoint of the bottom edge with a tolerance of 5 points on either side of the edge
           else:
              l4= [gray1[x+X-5,y+(Y//2)]<100,gray1[x+X-4,y+(Y//2)]<100,gray1[x+X-3,y+(Y//2)]<100,gray1[x+X-2,y+(Y//2)]<100,gray1[x+X-1,y+(Y//2)]<100,gray1[x+X,y+(Y//2)]<100,gray1[x+X+1,y+(Y//2)]<100,gray1[x+X+2,y+(Y//2)]<100,gray1[x+X+3,y+(Y//2)]<100,gray1[x+X+4,y+(Y//2)]<100,gray1[x+X+5,y+(Y//2)]<100]
              if any(l4):
                 A[i][j]+= 2**3
           j+=1
           x+=X
