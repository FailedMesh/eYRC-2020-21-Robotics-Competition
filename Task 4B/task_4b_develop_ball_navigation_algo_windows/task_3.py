...
def init_setup(rec_client_id):
    ...
    global sum_err_x, sum_err_y, prev_time, curr_time, prev_center_x, prev_center_y, overshot_x, overshot_y, prev_target_point
   ...
   #The following angles have been computed by iteratively using binary method to calculate angles that stabilize the ball
    #at the starting position to give the vision sensor enough time to sense the ball position.
    target_angle_x = 0
    target_angle_y = 0
